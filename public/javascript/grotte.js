...
document.getElementById("fleche-direction-sylverun").addEventListener("click", () =>{
    localStorage.setItem("village-anim", "true");
    location.href = "/jeu/sylverun";
})

if(document.getElementById("fleche-direction-grotte") !== null){
    document.getElementById("fleche-direction-grotte").addEventListener("click", () =>{
        localStorage.setItem("village-anim", "true");
        location.href = "/jeu/grotte";
    })
}